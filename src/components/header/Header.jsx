...
const Header = () => {
  ...
  return (
    <header className="w-full flex items-center justify-between py-4 px-6 bg-gradient-to-r from-primary-700 via-primary-900 to-primary-700 drop-shadow-lg shadow-lg fixed top-0 z-20">
